...
### 1. Restaurant Public Page
- while clicking on restaurant name or image from home page, it should open the restaurant public page
- on the click of link `see all` should show all the restaurants with paginations. 
- all restaurant page will also have a filter on the left side. 
- it should display the restaurant name, image, description, location, rating, etc.
- it should display the restaurant menu
- it should display the restaurant reviews
- it should display the restaurant opening hours
- it should display the restaurant location on map
- Responsive mobile design for mobile screen 
