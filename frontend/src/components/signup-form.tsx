          ...
          <form onSubmit={handleSubmit} className="p-6 md:p-8 flex flex-col justify-center">
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center">
                <h1 className="text-2xl font-bold tracking-tight text-foreground font-heading">Create an account</h1>
            ...
            {/* Partner Switcher Link */}
            <div className="mt-8 pt-6 border-t border-muted/50 flex justify-center text-xs font-semibold text-muted-foreground">
              <Link to="/restaurant/register" className="flex items-center gap-1 hover:text-primary transition-colors">
                <Store className="h-3.5 w-3.5 text-primary" />
                Are you a Restaurant Partner? Join Us
              </Link>
            </div>
          </form>
